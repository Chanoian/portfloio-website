...
const About = () => {
  return (
    <>
      <Head>
        <title>About Ara Chanoian | Portfolio</title>
        <meta name="description" content="Learn about Ara Chanoian, a technologist and engineer specializing in cloud infrastructure, DevOps, and scalable solutions." />
        <meta name="keywords" content="Ara Chanoian, Cloud Engineer, DevOps, Portfolio, Kubernetes, AWS, GCP, Docker" />
        <meta property="og:title" content="About Ara Chanoian | Portfolio" />
        <meta property="og:description" content="Learn about Ara Chanoian, a technologist and engineer specializing in cloud infrastructure, DevOps, and scalable solutions." />
        <meta property="og:image" content="/profile.png" />
        <meta property="og:url" content="https://your-portfolio.com/about" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Ara Chanoian | Portfolio" />
        <meta name="twitter:description" content="Learn about Ara Chanoian, a technologist and engineer specializing in cloud infrastructure, DevOps, and scalable solutions." />
